...
public class shipmentFlow extends FlowLogic<SignedTransaction> {
    ...
    //public constructor
    public shipmentFlow(String model, Party owner, Party sendTo){
        this.model = model;
        this.owner = owner;
...
*/
        // Initiator flow logic comes here

        // Retrieve the notary entity from the network map

            Party notary = getServiceHub().getNetworkMapCache().getNotaryIdentities().get(0);

        // Create the transactions components (Inputs / Outputs)
        ...
        // Verify the transaction with the notary and send it to the ledger?
        // Using this sub-flow to finalise the transaction, called finality flow
